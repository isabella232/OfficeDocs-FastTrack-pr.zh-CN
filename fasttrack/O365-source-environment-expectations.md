...
|**iOS 和 Android 版 Outlook**  | 在适用于 Office 365 的 Azure Active Directory 中启用标识。  <br/>配置了 Exchange Online 并分配了许可证。 |

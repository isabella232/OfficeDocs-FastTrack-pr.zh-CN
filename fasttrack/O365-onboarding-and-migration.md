...
有关每个阶段的具体任务，请参阅 [FastTrack 责任](O365-fasttrack-responsibilities.md)和[你的责任](O365-your-responsibilities.md)。
...
对于 Microsoft 信息管控，我们将提供以下方面的指导：
...
对于 Microsoft 信息保护，我们将提供以下方面的指导：
- 通过内容浏览器和活动浏览器了解你的数据。
- 敏感度标签。
- 数据分类。
- 针对 Microsoft Teams 聊天和频道的数据丢失防护 (DLP) 策略。
- 信息保护。
- 统一标记。

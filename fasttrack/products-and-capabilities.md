...
<li>  直接路由指南：
<ul>
<li>  合作伙伴托管方案的直接路由设计的组织设置指南，或最高10个网站的客户部署方案。  </li>
<li>  (SBC) 配置评审的会话边界控制器。 </li>
...
<li>  适用于 Skype for business 的团队转换指南。  </li>
</ul></td>
<td><ul>
...
<td>  我们提供了从 Windows 7 Professional 和 Windows 8.1 专业版升级到 Windows 10 企业版的指南。  
  我们为以下内容提供了远程指导：
<ul>
...
<td><p>我们提供了用于将 Windows 虚拟桌面 (到桌面和应用程序虚拟化服务) 的部署指南。 Windows 虚拟桌面利用 Windows 10 多会话体验，并针对 microsoft 365 的集成安全性和管理，针对适用于企业的 Microsoft 365 应用程序进行了优化。</p>
<p>我们为以下内容提供了远程指导：</p>
<ul>
<li>使用以下各项为企业版部署 windows 虚拟桌面环境： Windows 10 企业版多会话和 Microsoft 365 应用程序：
<ul>
<li>Azure Marketplace 图像。</li>
<li>共享图像。</li>
<li>Office 部署工具包 (ODT) 。</li>
</ul></li>
<li>配置 FSLogix：
<ul>
<li>使用配置文件容器部署 FSLogix 代理。</li>
<li>使用 Office 容器部署 FSLogix 代理。</li>
<li>配置包含内容排除的 FSLogix 文件夹。</li>
</ul></li>
<li>部署 Microsoft Edge。</li>
<li>部署 Microsoft 团队。</li>
...
<li>Azure 网络：
<ul>
<li> (VNET) 创建和子网的虚拟网络。</li>
<li>防火墙和网络安全组。</li>
<li>VPN 和 ExpressRoute。</li>
<li>从内部部署到 Azure 的路由。</li>
<li>允许连接到 Windows 虚拟桌面的防火墙规则。
</ul>
有关详细信息，请参阅 <a href="https://docs.microsoft.com/azure/virtual-desktop/overview#supported-remote-desktop-clients"> 支持的远程桌面客户端</a>。
</ul>
<ul><li>Azure AD 常规安装程序：
<ul>
<li>标识策略 <i> (只能使用以下三个选项之一) ：</i>
<ul>
<li>Azure 中具有 Azure AD Connect 的 Active Directory。</li>
<li>Azure AD 上的 Active Directory 与 VPN 或 ExpressRoute 上的本地连接。</li>
...
<td>  应用程序确保服务旨在解决 Windows 10 和 Microsoft 365 应用程序兼容性方面的问题。 当您请求应用程序确保服务时，我们将与您合作，以使用符合条件的订阅解决有效的应用问题，而无需额外付费。 我们还为在部署 Windows 虚拟桌面和新 Microsoft Edge 时面临兼容性问题的客户提供指导，并尽一切努力解决兼容性问题。 我们为以下 Microsoft 产品上部署的应用程序提供了修正帮助：
<ul>
<li>  <strong>Windows 10 </strong> (包括 ARM64 设备) </li>
<li> <strong>Microsoft 365 应用程序</strong>  </li>
<li>  <strong>新的 Microsoft Edge-</strong> 有关部署指南，请参阅 <a href="https://docs.microsoft.com/DeployEdge/microsoft-edge-channels">Microsoft Edge 通道概述</a>。  </li>
<li>  <strong>Windows 虚拟桌面</strong> - 有关详细信息，请参阅 <a href="https://docs.microsoft.com/azure/virtual-desktop/overview">什么是 Windows 虚拟桌面？</a> 和 <a href="https://docs.microsoft.com/azure/virtual-desktop/windows-10-multisession-faq">Windows 10 企业版多会话常见问题解答</a>。  </li>
</ul>
...
<strong>注意：</strong>  Microsoft 无法对您的源代码进行更改。 但是，如果可提供应用的源代码，则应用保证团队可向应用开发人员提供指导。 


  联系 <a href="https://go.microsoft.com/fwlink/?linkid=2080150">Microsoft 合作伙伴</a> 以获取有关这些服务的帮助。  </td>

</td>
<td><strong>Windows 10 和 Microsoft 365 应用程序</strong>
<ul>
<li>  
...
<li>  
  当 web 不断发展时，请务必查看此已发布的已知 <a href="https://docs.microsoft.com/microsoft-edge/web-platform/site-impacting-changes">网站兼容性列表。 Microsoft Edge 影响的更改</a>。  
  </li>
</ul>
...
<tr class="even">
<td>适用于 Windows 10 企业版客户的<strong>Microsoft Edge</strong> () </td>
<td><ul>
<li>  我们为以下内容提供了远程部署指导和兼容性协助：将 Windows 10 企业版中的新 Microsoft Edge 部署到 microsoft 终结点配置管理器或 Intune)  (microsoft 终结点管理器。  </li>
<li>  Microsoft Edge 配置 (使用组策略或 Intune 应用配置和应用程序策略) 。  </li>
<li>  清点可能需要在 Internet Explorer 模式中使用的网站列表。  </li>
<li>  使用现有企业网站列表启用 Internet Explorer 模式。  
  此外，如果您有一个可与 Internet Explorer 或 Google Chrome 配合使用的 web 应用或网站，并且您遇到兼容性问题，我们提供的指导可以无需额外付费即可解决问题。 有关详细信息，请参阅 <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#app-assure">应用程序的确保</a> 。  </li>
</ul>

...
<span data-ttu-id="d3d0e-144">我们的数据迁移服务从以下源环境迁移数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-144">Our data migration service migrates data from these source environments:</span></span>
...
<li> <span data-ttu-id="d3d0e-166">可恢复的项目</span><span class="sxs-lookup"><span data-stu-id="d3d0e-166">Recoverable items</span></span> </li>
</ul></td>
<td><ul>
...
<li> <span data-ttu-id="d3d0e-190">已损坏的项目</span><span class="sxs-lookup"><span data-stu-id="d3d0e-190">Corrupted items</span></span> </li>
...
## <a name="fasttrack-responsibilities-for-exchange-online-migrations"></a><span data-ttu-id="d3d0e-216">FastTrack 迁移Exchange Online责任</span><span class="sxs-lookup"><span data-stu-id="d3d0e-216">FastTrack responsibilities for Exchange Online migrations</span></span>
...
<span data-ttu-id="d3d0e-250">我们的数据迁移服务从以下源环境迁移数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-250">Our data migration services migrate data from these source environments:</span></span>
...
<ul>
<li> <span data-ttu-id="d3d0e-296">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-296">Created date</span></span> </li>
...
<li> <span data-ttu-id="d3d0e-373">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-373">Inaccessible or corrupted documents</span></span> </li>
...
<span data-ttu-id="d3d0e-388">此外，你还将执行以下特定于 SharePoint Online 迁移的活动：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-388">You also perform the following activities, specific to SharePoint Online migrations:</span></span>
...
<span data-ttu-id="d3d0e-402">我们的数据迁移服务从以下源环境迁移数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-402">Our data migration services migrate data from these source environments:</span></span>
  ...
  - <span data-ttu-id="d3d0e-403">文件共享（SMB 文件在支持 SMB 2.0 前向的设备上共享）。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-403">File shares (SMB file shares on devices supporting SMB 2.0 onward).</span></span>
...
<ul>
<li> <span data-ttu-id="d3d0e-448">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-448">Created date</span></span> </li>
...
<tr class="odd">
<td><span data-ttu-id="d3d0e-473"><strong>Box（Starter、Business、Enterprise）</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-473"><strong>Box (Starter, Business, Enterprise)</strong></span></span></td>
...
<li> <span data-ttu-id="d3d0e-478">组级别文件夹权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-478">Group-level folder permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-479">小于 15GB 的文件</span><span class="sxs-lookup"><span data-stu-id="d3d0e-479">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="d3d0e-480">基本文档和文件夹元数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-480">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="d3d0e-481">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-481">Created date</span></span> </li>
<li> <span data-ttu-id="d3d0e-482">修改日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-482">Modified date</span></span> </li>
<li> <span data-ttu-id="d3d0e-483">创建者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-483">Created by</span></span> </li>
<li> <span data-ttu-id="d3d0e-484">最后一次修改者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-484">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="d3d0e-485">属于 Box 帐户的共享内容会被迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-485">Shared content owned by the Box account being migrated</span></span> </li>
</ul></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-486">所有权历史记录、旧版本和注释</span><span class="sxs-lookup"><span data-stu-id="d3d0e-486">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="d3d0e-487">文件和文件夹说明</span><span class="sxs-lookup"><span data-stu-id="d3d0e-487">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="d3d0e-488">用户级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-488">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-489">组级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-489">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-490">Box 标记和高级元数据</span><span class="sxs-lookup"><span data-stu-id="d3d0e-490">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="d3d0e-491">文件锁定属性</span><span class="sxs-lookup"><span data-stu-id="d3d0e-491">File lock attributes</span></span> </li>
<li> <span data-ttu-id="d3d0e-492">内容中嵌入的 URL 的转换后对象</span><span class="sxs-lookup"><span data-stu-id="d3d0e-492">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="d3d0e-493">放入回收站的项</span><span class="sxs-lookup"><span data-stu-id="d3d0e-493">Trashed items</span></span> </li>
<li> <span data-ttu-id="d3d0e-494">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-494">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-495">被阻止的用户或非活动用户</span><span class="sxs-lookup"><span data-stu-id="d3d0e-495">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="d3d0e-496">Box 应用、书签、收藏夹和工作流</span><span class="sxs-lookup"><span data-stu-id="d3d0e-496">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="d3d0e-497">不属于已迁移 Box 帐户的内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-497">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="d3d0e-498">外部用户的权限和基本元数据（<strong>注意</strong>：使用 Box 报告确定与外部用户共享的内容。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-498">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="d3d0e-499">指示最终用户在迁移后与外部用户重新共享内容。）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-499">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="d3d0e-500">超出当前联机SharePoint<a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">限制的文件或文件夹</span></a> </span><span class="sxs-lookup"><span data-stu-id="d3d0e-500">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="d3d0e-501"><strong>用于 Teams的 Dropbox（标准版和高级版）</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-501"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="d3d0e-502">单通道或多通道</span><span class="sxs-lookup"><span data-stu-id="d3d0e-502">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-503">文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-503">Documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-504">文件和文件夹结构</span><span class="sxs-lookup"><span data-stu-id="d3d0e-504">File and folder structure</span></span> </li>
<li> <span data-ttu-id="d3d0e-505">用户级别文件夹权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-505">User-level folder permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-506">组级别文件夹权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-506">Group-level folder permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-507">小于 15GB 的文件</span><span class="sxs-lookup"><span data-stu-id="d3d0e-507">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="d3d0e-508">基本文档和文件夹元数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-508">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="d3d0e-509">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-509">Created date</span></span> </li>
<li> <span data-ttu-id="d3d0e-510">修改日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-510">Modified date</span></span> </li>
<li> <span data-ttu-id="d3d0e-511">创建者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-511">Created by</span></span> </li>
<li> <span data-ttu-id="d3d0e-512">最后一次修改者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-512">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="d3d0e-513">共享团队文件夹和内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-513">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="d3d0e-514">属于 Dropbox 帐户的共享内容会被迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-514">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-515">所有权历史记录、旧版本和注释</span><span class="sxs-lookup"><span data-stu-id="d3d0e-515">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="d3d0e-516">文件和文件夹说明</span><span class="sxs-lookup"><span data-stu-id="d3d0e-516">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="d3d0e-517">用户级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-517">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-518">组级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-518">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-519">高级元数据</span><span class="sxs-lookup"><span data-stu-id="d3d0e-519">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="d3d0e-520">文件锁定属性</span><span class="sxs-lookup"><span data-stu-id="d3d0e-520">File lock attributes</span></span> </li>
<li> <span data-ttu-id="d3d0e-521">内容中嵌入的 URL 的转换后对象</span><span class="sxs-lookup"><span data-stu-id="d3d0e-521">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="d3d0e-522">放入回收站的项</span><span class="sxs-lookup"><span data-stu-id="d3d0e-522">Trashed items</span></span> </li>
<li> <span data-ttu-id="d3d0e-523">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-523">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-524">已卸载的 Dropbox 文件夹</span><span class="sxs-lookup"><span data-stu-id="d3d0e-524">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="d3d0e-525">已删除或已断开连接的用户</span><span class="sxs-lookup"><span data-stu-id="d3d0e-525">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="d3d0e-526">Dropbox Paper 文件、Dropbox Showcase 和 Dropbox Space</span><span class="sxs-lookup"><span data-stu-id="d3d0e-526">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="d3d0e-527">Dropbox 应用及收藏夹（已固定或加星标）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-527">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="d3d0e-528">已迁移的 Dropbox 帐户不拥有的内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-528">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="d3d0e-529">外部用户的权限和基本元数据（<strong>注意</strong>：使用 Dropbox 报告确定与外部用户共享的内容。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-529">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="d3d0e-530">指示最终用户在迁移后与外部用户重新共享内容。）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-530">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="d3d0e-531">超出当前联机SharePoint<a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">限制的文件或文件夹</span></a> </span><span class="sxs-lookup"><span data-stu-id="d3d0e-531">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-onedrive-for-business-migrations"></a><span data-ttu-id="d3d0e-532">FastTrack 迁移OneDrive for Business责任</span><span class="sxs-lookup"><span data-stu-id="d3d0e-532">FastTrack responsibilities for OneDrive for Business migrations</span></span>

<span data-ttu-id="d3d0e-533">我们的 FastTrack 专家在迁移项目期间执行标准活动。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-533">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="d3d0e-534">有关详细信息，请参阅[流程和期望](process-and-expectations.md)中的数据迁移职责信息。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-534">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

### <a name="your-responsibilities"></a><span data-ttu-id="d3d0e-535">你的责任</span><span class="sxs-lookup"><span data-stu-id="d3d0e-535">Your responsibilities</span></span>

<span data-ttu-id="d3d0e-536">你在迁移项目期间执行标准活动。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-536">You perform standard activities during the migration project.</span></span> <span data-ttu-id="d3d0e-537">有关详细信息，请参阅[流程和期望](process-and-expectations.md)中的数据迁移职责信息。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-537">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

<span data-ttu-id="d3d0e-538">此外，你还将执行以下特定于 OneDrive for Business 迁移的活动：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-538">You also perform the following activities, specific to OneDrive for Business migrations:</span></span>

  - <span data-ttu-id="d3d0e-539">预置将作为迁移事件目标的所有 OneDrive for Business 网站。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-539">Provision all OneDrive for Business sites that will be targeted by your migration events.</span></span>

## <a name="migration-to-microsoft-teams-and-microsoft-365-groups"></a><span data-ttu-id="d3d0e-540">迁移到 Microsoft Teams 组Microsoft 365组</span><span class="sxs-lookup"><span data-stu-id="d3d0e-540">Migration to Microsoft Teams and Microsoft 365 Groups</span></span>

<span data-ttu-id="d3d0e-541">当你选择使用 FastTrack 将文件迁移到 Microsoft Teams Microsoft 365 组时，我们将提供迁移指南和数据迁移服务。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-541">When you choose to use FastTrack to migrate your files to Microsoft Teams and Microsoft 365 Groups, we provide migration guidance and data migration services.</span></span> <span data-ttu-id="d3d0e-542">我们提供的指南可帮助你规划迁移、配置源环境以及Teams Microsoft 365组，以及利用我们的数据迁移服务来迁移你的文件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-542">We provide guidance to help you plan your migration, configure your source environments and Teams and Microsoft 365 Groups, and leverage our data migration services to migrate your files.</span></span> <span data-ttu-id="d3d0e-543">你可以创建和安排迁移事件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-543">You create and schedule your migration events.</span></span> <span data-ttu-id="d3d0e-544">我们将根据你的日程安排启动迁移事件、监视其进度并提供状态报告。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-544">We launch migration events in accordance with your schedule, monitor their progress, and provide status reports.</span></span> <span data-ttu-id="d3d0e-545">迁移事件完成后，您可以预期源环境的适当计划源和符合条件的源中的文件已迁移到 Teams Microsoft 365 组。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-545">When your migration events are completed, you can expect files from appropriately scheduled and eligible sources of your source environments to have been migrated to Teams and Microsoft 365 Groups.</span></span> <span data-ttu-id="d3d0e-546">Teams频道Microsoft 365组必须先由客户预配，然后才能将数据迁移到这些目标类型。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-546">Teams channels and Microsoft 365 Groups  must be pre-provisioned by the customer before they can migrate data into these destination types.</span></span> <span data-ttu-id="d3d0e-547">Teams组Microsoft 365组会影响对文件目标位置的权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-547">Teams and Microsoft 365 Groups impacts your permissions on the file destination location.</span></span> <span data-ttu-id="d3d0e-548">Teams组Microsoft 365组，以允许协作。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-548">Teams and Microsoft 365 Groups are built to allow collaboration.</span></span> <span data-ttu-id="d3d0e-549">用户Teams或Microsoft 365组确定迁移到目标时谁有权访问这些文件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-549">The Teams channel or Microsoft 365 group determine who has access to those files when migrating into those destinations.</span></span> <span data-ttu-id="d3d0e-550">FastTrack 不会在迁移期间将最终用户或组添加到任何Teams或Microsoft 365组"权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-550">FastTrack doesn't add end users or groups to any Teams channel or Microsoft 365 Groups permission during migration.</span></span>

### <a name="considerations"></a><span data-ttu-id="d3d0e-551">注意事项</span><span class="sxs-lookup"><span data-stu-id="d3d0e-551">Considerations</span></span>

- <span data-ttu-id="d3d0e-552">所有迁移均受 SharePoint Online 配额的限制。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-552">All migrations are subject to SharePoint Online quotas.</span></span> <span data-ttu-id="d3d0e-553">有关详细信息<a href="https://go.microsoft.com/fwlink/?LinkId=698855">，SharePoint</a>限制。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-553">Refer to <a href="https://go.microsoft.com/fwlink/?LinkId=698855"> SharePoint limits</a> for details.</span></span> 
- <span data-ttu-id="d3d0e-554">建议将迁移总量限制在你享有的整体 SharePoint Online 存储配额（包括你可能单独购买的其他存储）的 75% 以内。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-554">We recommend that you limit the overall amount of migrate to 75 percent of the overall SharePoint Online storage quota to which you are entitled (including the additional storage you may have purchased separately).</span></span> 


### <a name="source-environment-details"></a><span data-ttu-id="d3d0e-555">源环境详细信息</span><span class="sxs-lookup"><span data-stu-id="d3d0e-555">Source environment details</span></span>

<span data-ttu-id="d3d0e-556">我们的数据迁移服务从以下源环境迁移数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-556">Our data migration services migrate data from these source environments:</span></span> 

- <span data-ttu-id="d3d0e-557">文件共享（支持 SMB 2.0 前向的设备上的服务器消息块 (SMB) 文件共享）。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-557">File shares (Server Message Block (SMB) file shares on devices supporting SMB 2.0 onward).</span></span>
-  <span data-ttu-id="d3d0e-558">单个 G 套件环境（仅限 Google Drive）。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-558">A single G Suite environment (Google Drive only).</span></span> 
- <span data-ttu-id="d3d0e-559">Box（Starter、Business、Enterprise）。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-559">Box (Starter, Business, Enterprise).</span></span> 
- <span data-ttu-id="d3d0e-560">用于 Teams的 Dropbox（标准版和高级版）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-560">Dropbox for Teams (Standard and Advanced).</span></span> 

<span data-ttu-id="d3d0e-561">下表显示了特定于每个源环境的迁移详细信息：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-561">The following table presents migration details specific to each source environment:</span></span>

<table>
<thead>
<tr class="header">
 <th><span data-ttu-id="d3d0e-562"><strong>源环境</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-562"><strong>Source environment</strong></span></span></th>
 <th><span data-ttu-id="d3d0e-563"><strong>迁移类型</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-563"><strong>Type of migration</strong></span></span></th>
 <th><span data-ttu-id="d3d0e-564"><strong>迁移内容</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-564"><strong>What migrates</strong></span></span></th>
 <th><span data-ttu-id="d3d0e-565"><strong>不迁移的内容</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-565"><strong>What doesn't migrate</strong></span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><span data-ttu-id="d3d0e-566"><strong>任何支持 SMB 2.0 及更高版本的文件共享设备</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-566"><strong>Any file share device supporting SMB 2.0 onward</strong></span></span></td>
<td><span data-ttu-id="d3d0e-567">单通道或多通道</span><span class="sxs-lookup"><span data-stu-id="d3d0e-567">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-568">文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-568">Documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-569">文件和文件夹结构</span><span class="sxs-lookup"><span data-stu-id="d3d0e-569">File and folder structure</span></span> </li>
<li> <span data-ttu-id="d3d0e-570">用户级别的文件和文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-570">User-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-571">组级别的文件和文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-571">Group-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-572">小于 15GB 的文件</span><span class="sxs-lookup"><span data-stu-id="d3d0e-572">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="d3d0e-573">基本文档和文件夹元数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-573">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="d3d0e-574">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-574">Created date</span></span> </li>
<li> <span data-ttu-id="d3d0e-575">修改日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-575">Modified date</span></span> </li>
<li> <span data-ttu-id="d3d0e-576">创建者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-576">Created by</span></span> </li>
<li> <span data-ttu-id="d3d0e-577">最后一次修改者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-577">Last modified by</span></span> </li>
</ul></li>
</ul>
<br>
<span data-ttu-id="d3d0e-578">\*必须配置目录同步。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-578">\*Directory synchronization configuration required.</span></span> <span data-ttu-id="d3d0e-579">只迁移对 Windows 文件资源管理器公开的 NTFS 权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-579">Only NTFS permissions exposed to the Windows File Explorer are migrated.</span></span> <span data-ttu-id="d3d0e-580">不会迁移文件共享设备上直接托管的权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-580">Permissions managed directly on file share devices are not migrated.</span></span> <span data-ttu-id="d3d0e-581">如果数据存储在 SMB 2.0 设备上，只会迁移 SMB 协议公开的与 NTFS 等同的权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-581">If data is stored on an SMB 2.0 device, the NTFS-equivalent permissions exposed by the SMB protocol are migrated.</span></span> <span data-ttu-id="d3d0e-582">权限受组和/或Microsoft 365频道Microsoft Teams影响。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-582">Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="d3d0e-583">如果目标为Microsoft 365或Microsoft Teams组或频道，则组或频道将确定迁移文件的最终权限配置文件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-583">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="d3d0e-584">建议不要迁移迁移到组或Microsoft 365组Microsoft Teams权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-584">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-585">所有权历史记录和旧版本</span><span class="sxs-lookup"><span data-stu-id="d3d0e-585">Ownership history and previous versions</span></span> </li>
<li> <span data-ttu-id="d3d0e-586">内容中嵌入的 URL 的转换后对象</span><span class="sxs-lookup"><span data-stu-id="d3d0e-586">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="d3d0e-587">旧版本</span><span class="sxs-lookup"><span data-stu-id="d3d0e-587">Previous versions</span></span> </li>
<li> <span data-ttu-id="d3d0e-588">Windows 文件和文件夹属性（如只读和隐藏）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-588">Windows file and folder attributes (like read-only and hidden)</span></span> </li>
<li> <span data-ttu-id="d3d0e-589">非 Windows 新技术文件系统 (NTFS) 和 NTFS 高级权限和特殊设置：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-589">Non-Windows New Technology File System (NTFS) and NTFS advanced permissions and special settings:</span></span> </li>
<li> <span data-ttu-id="d3d0e-590">显式拒绝权限（在迁移后删除的权限、从属于并行权限的内容或父文件夹上的权限）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-590">Explicit deny permissions (removed after migration, content subject to parallel permissions or permissions on parent folder)</span></span> </li>
<li> <span data-ttu-id="d3d0e-591">NTFS 审核配置</span><span class="sxs-lookup"><span data-stu-id="d3d0e-591">NTFS auditing configuration</span></span> </li>
<li> <span data-ttu-id="d3d0e-592">文件分类基础结构 (FCI) 提供的附加文件元数据</span><span class="sxs-lookup"><span data-stu-id="d3d0e-592">Additional file metadata provided by File Classification Infrastructure (FCI)</span></span> </li>
<li> <span data-ttu-id="d3d0e-593">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-593">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-594">隐藏的共享</span><span class="sxs-lookup"><span data-stu-id="d3d0e-594">Hidden shares</span></span> </li>
<li> <span data-ttu-id="d3d0e-595">共享（如在共享级别授予的权限）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-595">Sharing (like permissions granted on the share level)</span></span> </li>
<li> <span data-ttu-id="d3d0e-596">超出当前联机SharePoint<a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">限制的文件或文件夹</span></a> </span><span class="sxs-lookup"><span data-stu-id="d3d0e-596">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="d3d0e-597"><strong>单个 G 套件环境（仅限 Google 云端硬盘）</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-597"><strong>Single G Suite environment (Google Drive only)</strong></span></span></td>
<td><span data-ttu-id="d3d0e-598">单通道或多通道</span><span class="sxs-lookup"><span data-stu-id="d3d0e-598">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-599">Google 文档、工作表和幻灯片（文件包括超过10 MB的，转换为等同的 Office 格式）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-599">Google Docs, Sheets, and Slides (files are converted to the equivalent Office format including those over 10 MB)</span></span> </li>
<li> <span data-ttu-id="d3d0e-600">文件和文件夹结构</span><span class="sxs-lookup"><span data-stu-id="d3d0e-600">File and folder structure</span></span> </li>
<li> <span data-ttu-id="d3d0e-601">用户级别文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-601">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-602">组级别文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-602">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-603">小于 15GB 的文件</span><span class="sxs-lookup"><span data-stu-id="d3d0e-603">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="d3d0e-604">基本文档和文件夹元数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-604">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="d3d0e-605">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-605">Created date</span></span> </li>
<li> <span data-ttu-id="d3d0e-606">修改日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-606">Modified date</span></span> </li>
<li> <span data-ttu-id="d3d0e-607">创建者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-607">Created by</span></span> </li>
<li> <span data-ttu-id="d3d0e-608">最后一次修改者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-608">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="d3d0e-609">共享驱动器 （文件夹和文件）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-609">Shared drives (folders and files)</span></span> </li>
<li> <span data-ttu-id="d3d0e-610">属于 Google 云端硬盘帐户的共享内容会被迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-610">Shared content owned by the Google Drive account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="d3d0e-611">\*权限受组和/Microsoft 365频道Microsoft Teams影响。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-611">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="d3d0e-612">如果目标为Microsoft 365或Microsoft Teams组或频道，则组或频道将确定迁移文件的最终权限配置文件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-612">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="d3d0e-613">建议不要迁移迁移到组或Microsoft 365组Microsoft Teams权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-613">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> 
</td>
<td><ul>
<li> <span data-ttu-id="d3d0e-614">所有权历史记录、旧版本和注释</span><span class="sxs-lookup"><span data-stu-id="d3d0e-614">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="d3d0e-615">文件和文件夹说明、文件夹颜色</span><span class="sxs-lookup"><span data-stu-id="d3d0e-615">File and folder descriptions, folder colors</span></span> </li>
<li> <span data-ttu-id="d3d0e-616">用户级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-616">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-617">组级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-617">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-618">高级元数据</span><span class="sxs-lookup"><span data-stu-id="d3d0e-618">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="d3d0e-619">文件锁定属性</span><span class="sxs-lookup"><span data-stu-id="d3d0e-619">File lock attributes</span></span> </li>
<li> <span data-ttu-id="d3d0e-620">内容中嵌入的 URL 的转换后对象</span><span class="sxs-lookup"><span data-stu-id="d3d0e-620">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="d3d0e-621">放入回收站的项</span><span class="sxs-lookup"><span data-stu-id="d3d0e-621">Trashed items</span></span> </li>
<li> <span data-ttu-id="d3d0e-622">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-622">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-623">被阻止的用户或非活动用户</span><span class="sxs-lookup"><span data-stu-id="d3d0e-623">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="d3d0e-624">Google 相册、Forms、地图和其他已连接应用</span><span class="sxs-lookup"><span data-stu-id="d3d0e-624">Google Photos Forms, Maps, and other connected apps</span></span> </li>
<li> <span data-ttu-id="d3d0e-625">Google 绘图</span><span class="sxs-lookup"><span data-stu-id="d3d0e-625">Google Drawings</span></span> </li>
<li> <span data-ttu-id="d3d0e-626">组织外部的共享内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-626">Shared content external to your organization</span></span> </li>
<li> <span data-ttu-id="d3d0e-627">不属于Google 云端硬盘帐户的内容被迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-627">Content not owned by the Google Drive account being migrated</span></span> </li>
<li> <span data-ttu-id="d3d0e-628">外部用户的权限和基本元数据（<strong>注意</strong>：使用 Google 云端硬盘管理报告确定与外部用户共享的内容。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-628">Permissions and basic metadata of external users (<strong>Note</strong>: Use Google Drive Admin reports to identify content shared with external users.</span></span> <span data-ttu-id="d3d0e-629">指示最终用户在迁移后与外部用户重新共享内容。）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-629">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="d3d0e-630">共享驱动器成员资格权限（<strong>注意</strong>：使用 Google 云端硬盘管理报告来标识共享驱动器成员资格。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-630">Shared drive membership permissions (<strong>Note</strong>: Use Google Drive Admin reports to identify shared drive memberships.</span></span> <span data-ttu-id="d3d0e-631">指示最终用户迁移前在目标上配置这些成员资格设置。）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-631">Instruct end users to configure these membership settings on the target before migration.)</span></span> </li>
<li> <span data-ttu-id="d3d0e-632">超出当前联机SharePoint<a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">限制的文件或文件夹</span></a> </span><span class="sxs-lookup"><span data-stu-id="d3d0e-632">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="d3d0e-633"><strong>Box（Starter、Business、Enterprise）</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-633"><strong>Box (Starter, Business, Enterprise)</strong></span></span></td>
<td><span data-ttu-id="d3d0e-634">单通道或多通道</span><span class="sxs-lookup"><span data-stu-id="d3d0e-634">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-635">文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-635">Documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-636">文件和文件夹结构</span><span class="sxs-lookup"><span data-stu-id="d3d0e-636">File and folder structure</span></span> </li>
<li> <span data-ttu-id="d3d0e-637">用户级别文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-637">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-638">组级别文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-638">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-639">小于 15GB 的文件</span><span class="sxs-lookup"><span data-stu-id="d3d0e-639">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="d3d0e-640">基本文档和文件夹元数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-640">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="d3d0e-641">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-641">Created date</span></span> </li>
<li> <span data-ttu-id="d3d0e-642">修改日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-642">Modified date</span></span> </li>
<li> <span data-ttu-id="d3d0e-643">创建者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-643">Created by</span></span> </li>
<li> <span data-ttu-id="d3d0e-644">最后一次修改者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-644">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="d3d0e-645">属于 Box 帐户的共享内容会被迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-645">Shared content owned by the Box account being migrated</span></span> </li>
<li> <span data-ttu-id="d3d0e-646">转换为 Word 文档 (格式的方框) </span><span class="sxs-lookup"><span data-stu-id="d3d0e-646">Box Notes (converted to Word document format)</span></span> </li>
</ul>
<br>
<span data-ttu-id="d3d0e-647">\*权限受组和/Microsoft 365频道Microsoft Teams影响。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-647">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="d3d0e-648">如果目标为Microsoft 365或Microsoft Teams组或频道，则组或频道将确定迁移文件的最终权限配置文件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-648">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="d3d0e-649">建议不要迁移迁移到组或Microsoft 365组Microsoft Teams权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-649">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> </td>
<td><ul>
<li> <span data-ttu-id="d3d0e-650">所有权历史记录、旧版本和注释</span><span class="sxs-lookup"><span data-stu-id="d3d0e-650">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="d3d0e-651">文件和文件夹说明</span><span class="sxs-lookup"><span data-stu-id="d3d0e-651">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="d3d0e-652">用户级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-652">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-653">组级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-653">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-654">Box 标记和高级元数据</span><span class="sxs-lookup"><span data-stu-id="d3d0e-654">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="d3d0e-655">文件锁定属性</span><span class="sxs-lookup"><span data-stu-id="d3d0e-655">File lock attributes</span></span> </li>
<li> <span data-ttu-id="d3d0e-656">内容中嵌入的 URL 的转换后对象</span><span class="sxs-lookup"><span data-stu-id="d3d0e-656">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="d3d0e-657">放入回收站的项</span><span class="sxs-lookup"><span data-stu-id="d3d0e-657">Trashed items</span></span> </li>
<li> <span data-ttu-id="d3d0e-658">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-658">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-659">被阻止的用户或非活动用户</span><span class="sxs-lookup"><span data-stu-id="d3d0e-659">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="d3d0e-660">Box 应用、书签、收藏夹和工作流</span><span class="sxs-lookup"><span data-stu-id="d3d0e-660">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="d3d0e-661">不属于已迁移 Box 帐户的内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-661">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="d3d0e-662">外部用户的权限和基本元数据（<strong>注意</strong>：使用 Box 报告确定与外部用户共享的内容。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-662">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="d3d0e-663">指示最终用户在迁移后与外部用户重新共享内容。）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-663">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="d3d0e-664">超出当前联机SharePoint<a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">限制的文件或文件夹</span></a> </span><span class="sxs-lookup"><span data-stu-id="d3d0e-664">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="d3d0e-665"><strong>用于 Teams的 Dropbox（标准版和高级版）</strong></span><span class="sxs-lookup"><span data-stu-id="d3d0e-665"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="d3d0e-666">单通道或多通道</span><span class="sxs-lookup"><span data-stu-id="d3d0e-666">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="d3d0e-667">文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-667">Documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-668">文件和文件夹结构</span><span class="sxs-lookup"><span data-stu-id="d3d0e-668">File and folder structure</span></span> </li>
<li> <span data-ttu-id="d3d0e-669">用户级别文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-669">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-670">组级别文件夹权限\*</span><span class="sxs-lookup"><span data-stu-id="d3d0e-670">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="d3d0e-671">小于 15GB 的文件</span><span class="sxs-lookup"><span data-stu-id="d3d0e-671">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="d3d0e-672">基本文档和文件夹元数据：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-672">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="d3d0e-673">创建日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-673">Created date</span></span> </li>
<li> <span data-ttu-id="d3d0e-674">修改日期</span><span class="sxs-lookup"><span data-stu-id="d3d0e-674">Modified date</span></span> </li>
<li> <span data-ttu-id="d3d0e-675">创建者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-675">Created by</span></span> </li>
<li> <span data-ttu-id="d3d0e-676">最后一次修改者</span><span class="sxs-lookup"><span data-stu-id="d3d0e-676">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="d3d0e-677">共享团队文件夹和内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-677">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="d3d0e-678">属于 Dropbox 帐户的共享内容会被迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-678">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="d3d0e-679">\*权限受组和/Microsoft 365频道Microsoft Teams影响。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-679">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="d3d0e-680">如果目标为Microsoft 365或Microsoft Teams组或频道，则组或频道将确定迁移文件的最终权限配置文件。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-680">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="d3d0e-681">建议不要迁移迁移到组或Microsoft 365组Microsoft Teams权限。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-681">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span>
</td>
<td><ul>
<li> <span data-ttu-id="d3d0e-682">所有权历史记录、旧版本和注释</span><span class="sxs-lookup"><span data-stu-id="d3d0e-682">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="d3d0e-683">文件和文件夹说明</span><span class="sxs-lookup"><span data-stu-id="d3d0e-683">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="d3d0e-684">用户级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-684">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-685">组级别文件权限</span><span class="sxs-lookup"><span data-stu-id="d3d0e-685">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="d3d0e-686">高级元数据</span><span class="sxs-lookup"><span data-stu-id="d3d0e-686">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="d3d0e-687">文件锁定属性</span><span class="sxs-lookup"><span data-stu-id="d3d0e-687">File lock attributes</span></span> </li>
<li> <span data-ttu-id="d3d0e-688">内容中嵌入的 URL 的转换后对象</span><span class="sxs-lookup"><span data-stu-id="d3d0e-688">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="d3d0e-689">放入回收站的项</span><span class="sxs-lookup"><span data-stu-id="d3d0e-689">Trashed items</span></span> </li>
<li> <span data-ttu-id="d3d0e-690">无法访问或已损坏的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-690">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="d3d0e-691">已卸载的 Dropbox 文件夹</span><span class="sxs-lookup"><span data-stu-id="d3d0e-691">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="d3d0e-692">已删除或已断开连接的用户</span><span class="sxs-lookup"><span data-stu-id="d3d0e-692">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="d3d0e-693">Dropbox Paper 文件、Dropbox Showcase 和 Dropbox Space</span><span class="sxs-lookup"><span data-stu-id="d3d0e-693">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="d3d0e-694">Dropbox 应用及收藏夹（已固定或加星标）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-694">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="d3d0e-695">已迁移的 Dropbox 帐户不拥有的内容</span><span class="sxs-lookup"><span data-stu-id="d3d0e-695">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="d3d0e-696">外部用户的权限和基本元数据（<strong>注意</strong>：使用 Dropbox 报告确定与外部用户共享的内容。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-696">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="d3d0e-697">指示最终用户在迁移后与外部用户重新共享内容。）</span><span class="sxs-lookup"><span data-stu-id="d3d0e-697">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="d3d0e-698">超出当前联机SharePoint<a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">限制的文件或文件夹</span></a> </span><span class="sxs-lookup"><span data-stu-id="d3d0e-698">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-microsoft-teams-and-microsoft-365-groups-migrations"></a><span data-ttu-id="d3d0e-699">FastTrack 负责Microsoft Teams Microsoft 365组迁移</span><span class="sxs-lookup"><span data-stu-id="d3d0e-699">FastTrack responsibilities for Microsoft Teams and Microsoft 365 Groups migrations</span></span>

<span data-ttu-id="d3d0e-700">我们的 FastTrack 专家在迁移项目期间执行标准活动。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-700">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="d3d0e-701">有关详细信息，请参阅[流程和期望](process-and-expectations.md)中的数据迁移职责信息。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-701">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

### <a name="your-responsibilities"></a><span data-ttu-id="d3d0e-702">你的责任</span><span class="sxs-lookup"><span data-stu-id="d3d0e-702">Your responsibilities</span></span> 

<span data-ttu-id="d3d0e-703">你在迁移项目期间执行标准活动。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-703">You perform standard activities during the migration project.</span></span> <span data-ttu-id="d3d0e-704">有关详细信息，请参阅[流程和期望](process-and-expectations.md)中的数据迁移职责信息。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-704">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>
<span data-ttu-id="d3d0e-705">还可以执行以下特定于组迁移Microsoft Teams Microsoft 365组迁移：</span><span class="sxs-lookup"><span data-stu-id="d3d0e-705">You also perform the following activities, specific to Microsoft Teams and Microsoft 365 Groups migrations:</span></span> 

- <span data-ttu-id="d3d0e-706">根据Microsoft Teams事件Microsoft 365设置所有频道和组。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-706">Provision all Microsoft Teams channels and Microsoft 365 Groups as targeted by your migration events.</span></span>

> [!NOTE]
><span data-ttu-id="d3d0e-707">FastTrack 不会预先预配Microsoft Teams或Microsoft 365组。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-707">FastTrack doesn't pre-provision Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="d3d0e-708">FastTrack 不会将最终用户或组添加到Microsoft Teams组或Microsoft 365组。</span><span class="sxs-lookup"><span data-stu-id="d3d0e-708">FastTrack doesn't add end users or groups to Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="d3d0e-709">在将数据迁移到目标之前，您必须将最终用户或组添加到所有 Microsoft Teams 频道和 Microsoft 365 组，以便这些最终用户能够访问新迁移的文档</span><span class="sxs-lookup"><span data-stu-id="d3d0e-709">You must add your end users or groups to all Microsoft Teams channels and Microsoft 365 Groups before you migrate data into those destinations so those end users have access to those newly migrated documents</span></span>
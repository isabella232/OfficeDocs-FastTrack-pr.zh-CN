...
|Exchange 2003 前向|直接转换| 电子邮件 <br/> 邮箱规则 <br/> 代理 <br/> 邮箱联系人 <br/> 日历 <br/> 任务 | 公用文件夹 <br/> 个人联系人 <br/> 启用邮件的用户 <br/> 被阻止的用户或非活动用户 <br/> 签名 <br/> 邮箱转储程序 <br/>  超出邮件大小限制的所有电子邮件 <br/> 存档数据 <br/> 权限管理或加密电子邮件 <br/> 已损坏的项目 <br/>  非活动邮箱 |
...
|:-----|:-----|
|**源** <br/> |**计划策略** <br/> |
|文件共享，框  <br/> | 基于预定义迁移批处理（每周五天全天候）。  <br/>  每个迁移日三个迁移批处理。  <br/>  一周有五个迁移日，从 UTC 时间星期一凌晨 2:00 到星期五午夜 。  <br/>  最后一次计划迁移窗口是 UTC 时间星期五晚上 8:00。  <br/> |
...
|:-----|:-----|
|**源** <br/> |**计划策略** <br/> |
|文件共享、Box、Google Drive  <br/> | 基于预定义迁移批处理（每周五天全天候）。  <br/>  每个迁移日三个迁移批处理。  <br/>  一周有五个迁移日，从 UTC 时间星期一凌晨 2:00 到星期五午夜 。  <br/>  最后一次计划迁移窗口是 UTC 时间星期五晚上 8:00。  <br/> |

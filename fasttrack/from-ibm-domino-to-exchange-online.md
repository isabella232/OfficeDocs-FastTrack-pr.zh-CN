...
- FastTrack 中心在 Azure 中设置迁移环境。
    
- FastTrack 中心在本地管理工作站上配置迁移工具。
    
- FastTrack 中心配置和演示如何使用自动导入工具。
    
- FastTrack 中心实施所有迁移组件验证并执行测试迁移。
...
- FastTrack 中心执行试点迁移和快速迁移。 
    
- FastTrack 中心执行迁移事件和倒计时活动。
    
- FastTrack 中心提供了迁移后协助。
